...
public struct FontStyling
{
    ...
    */
    ...
    public func boldTrait() -> FontTrait
    {
        ...
        fatalError("Failed to reach conclusion for BoldTrait, for FontInfo: \(self)")
    }
    ...
    public func italicsTrait() -> FontTrait
    {
        ...
        fatalError("Failed to reach conclusion for ItalicTrait, for FontInfo: \(self)")
    }
    ...
    public func underlineTrait() -> FontTrait
    {
        ...
        fatalError("Failed to reach conclusion for UnderlineTrait, for FontInfo: \(self)")
    }
    ...
    public func strikethroughTrait() -> FontTrait
    {
        ...
        fatalError("Failed to reach conclusion for StrikethroughTrait, for FontInfo: \(self)")
    }
